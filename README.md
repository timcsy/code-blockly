...
| **概念重構** | `/concept.refactor {lang} audit\|migrate\|dedup\|full` | 審計雙重註冊、遷移 hand-written → JSON pattern、清理技術債 |
