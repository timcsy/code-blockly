...
9. [積木定義的兩層架構](#9-積木定義的兩層架構)
10. [程式碼產生的優先順序](#10-程式碼產生的優先順序)
11. [Lifting（程式碼→積木）](#11-lifting程式碼積木)
12. [積木提取（Blockly→Semantic）](#12-積木提取blocklysemantic)
13. [Concept 與 Registry](#13-concept-與-registry)
14. [i18n 國際化](#14-i18n-國際化)
15. [Toolbox 與認知層級](#15-toolbox-與認知層級)
16. [動態積木常用模式](#16-動態積木常用模式)
17. [加入新語言的完整清單](#17-加入新語言的完整清單)
18. [常見陷阱與解法](#18-常見陷阱與解法)
